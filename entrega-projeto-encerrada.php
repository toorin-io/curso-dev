...
?>
	...
	<header class="content header">
		<h1>Entrega de projetos encerrada!</h1>
	</header>

	<section class="content">
		<div class="video">
			<iframe width="100%" height="550px" src="https://player.vimeo.com/video/762991400?h=fc0133d52a&amp" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</section>
