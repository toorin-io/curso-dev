...
<link href="https://fonts.googleapis.com/css2?family=Lato&family=Sora&family=Roboto&family=IBM+Plex+Sans:wght@400;600&display=swap" rel="stylesheet">
  <form method="POST" action="https://conquistandosuavaga.activehosted.com/proc.php" id="_form_10_" class="_form _form_10 _inline-form  _dark" novalidate>
    ...
    <input type="hidden" name="or" value="ebbacf73beaef65bf849755cc7e19914" />
    <div class="_form-content">
      <div class="_form_element _x01430481 _full_width " >
      ...
      <div class="_form_element _x36318529 _full_width " >
      ...
      <div class="_form_element _x89362226 _full_width " >
      ...
      <div class="_form_element _x19783229 _full_width " >
        <label for="field[19]" class="_form-label">
          Mora em qual cidade e estado?
        </label>
        <div class="_field-wrapper">
          <textarea id="field[19]" name="field[19]" placeholder=""  ></textarea>
        </div>
      </div>
      <div class="_form_element _x43682968 _full_width " >
      ...
      <div class="_form_element _x37487735 _full_width " >
        <fieldset class="_form-fieldset">
          <legend class="_form-label">
            Hoje está empregado?
          </legend>
          <div class="_row _checkbox-radio">
            <input id="field_4Sim" type="radio" name="field[4]" value="Sim"  >
            <span>
              <label for="field_4Sim">
                Sim
              </span>
            </div>
            <div class="_row _checkbox-radio">
              <input id="field_4Não" type="radio" name="field[4]" value="Não"  >
              <span>
                <label for="field_4Não">
                  Não
                </span>
              </div>
            </fieldset>
          </div>
          <div class="_form_element _x09398445 _full_width " >
            <label for="field[5]" class="_form-label">
              Atualmente trabalha em qual area?
            </label>
            <div class="_field-wrapper">
              <input type="text" id="field[5]" name="field[5]" value="" placeholder="" />
            </div>
          </div>
          <div class="_form_element _x80519989 _full_width " >
            <label for="field[3]" class="_form-label">
              Por que você deseja ser dev?
            </label>
            <div class="_field-wrapper">
              <input type="text" id="field[3]" name="field[3]" value="" placeholder="" />
            </div>
          </div>
          <div class="_form_element _x31364405 _full_width " >
            <label for="field[6]" class="_form-label">
              Já está praticando alguma linguagem de programação? Caso sim, qual?
            </label>
            <div class="_field-wrapper">
              <input type="text" id="field[6]" name="field[6]" value="" placeholder="" />
            </div>
          </div>
          <div class="_form_element _x64941638 _full_width " >
          ...
          <div class="_form_element _x78824834 _full_width " >
            <label for="field[14]" class="_form-label">
              O que falta para você conquistar sua vaga como dev?
            </label>
            <div class="_field-wrapper">
          ...
          <div class="_button-wrapper _full_width">
            <button id="_form_10_submit" class="_submit" type="submit">
              Fazer inscrição para aula ao vivo!
            </button>
          </div>
...
window.cfields = {"2":"data_de_nascimento","19":"cidade","20":"gnero","4":"empregado","5":"profisso","3":"motivao","6":"tecnologia","21":"escolaridade","14":"o_que_falta"};
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://conquistandosuavaga.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
