<div id="ac-form-aula" class="_form_14">
  <style>
    div#cform_14 div {
      display: flex;
    ...
    div#cform_14 input:focus-visible {
      outline: none;
    }
    div#cform_14 button {
      margin-top: 20px;
  ...
  <div id="cform_14">
    ...
    <button id="cform_14_submit">Quero assistir à aula!</button>
  </div>
</div>
<!-- <script
  src="https://conquistandosuavaga.activehosted.com/f/embed.php?id=14"
...
<script>
  ...
  const buttonSubmit = document.getElementById("cform_14_submit");
  let email = "";
  let firstName = "";
  let lastName = "";
